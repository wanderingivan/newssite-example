 ...
 * and registers 3 filters - spring's multipart filter to parse csrf tokens 
 * spring security's DelegatingFilterProxy
 * and struts's PrepareAndExecuteFilter
 */
public class NewsSiteInitializer implements WebApplicationInitializer {
	...
	private AnnotationConfigWebApplicationContext setUpAppContext(){
        ...
        appContext.register(NewsSiteConfig.class);
        return appContext;
	}
}
