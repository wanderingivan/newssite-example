...
<html lang="en">
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/newssite.js"></script>
  	    ...
  	    <div class="col-md-6 col-sm-6 col-xs-12">
  	      ...
  	      <div class="col-md-12">
  		    <div class="panel panel-default orders">
 		      <div class="panel-heading">Latest Comments <span class="pull-right"><i class="fa fa-minus-square"></i></span></div>
  		        <div class="panel-body">
  			    <s:iterator value="newestComments">
  			      <s:url action="show" namespace="/article" var="showArticle">
  			      ...
  			      <div class="media">
  				    <div class="media-body">
  				      <h4 class="media-heading">Comment Id : <s:property value="id"/></h4>
  				      <p style="padding:5px;">Sent <s:date name="posted" format="dd/MM/yyyy"/></p>
  				      <p>Message : <s:property value="message"/></p>
  				      <p>Sent by <s:a href="%{showUser}"><s:property value="poster.username"/></s:a>
  				      <p>Article <s:a href="%{showArticle}"><s:property value="article.headline"/></s:a></p>
  				    </div>
  			      </div>
  		        </s:iterator>
  		      </div>
  	    ...
  	    <div class="col-md-6 col-sm-6 col-xs-12">
  	      <div class="col-md-12">
  		    <div class="panel panel-default products">
 		      <div class="panel-heading">Latest Articles <span id="t" class="pull-right"><i class="fa fa-minus-square"></i></span></div>
  		      <div class="panel-body">
  			    <s:iterator value="newestArticles">
  			      <s:url action="show" namespace="/article" var="loadArticle">
  			   	    <s:param name="headline" value="headline"/>
  			      </s:url>
  			      <s:url action="loadImage" namespace="/util" var="articleImage">
  			   	    <s:param name="path" value="%{imagePath}"/>
  			      </s:url>
  			      <div class="media">
  				    <div class="media-body">
  				      <div class="media-left">
  				        <div class="image-container">
  				          <s:a href="%{loadArticle}"><img src="<s:property value='#articleImage'/>"/></s:a>
  				        </div>
  				      </div>
  				      <div class="media-right">
    				    <h4 class="media-heading"><s:a href="%{loadArticle}"><s:property value="headline"/></s:a></h4>
  				        <p class="text-muted">Last Edited:&nbsp;<s:date name="lastEdited" nice="true"/></p>
  				      </div>
  				    </div>
  			      </div>
  			    </s:iterator>
