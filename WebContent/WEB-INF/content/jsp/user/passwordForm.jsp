		...
		<div class="row">
	      <div class="col-md-12">
            ...
            <div class="col-md-offset-1 col-md-10 col-sm-12">
	      	<s:form action="changePassword" namespace="/user" cssClass="form-wrapper" theme="simple" enctype="multipart/form-data">
              <div class="form-group">
	              <s:fielderror fieldName="oldPassword" cssClass="alert alert-danger text-center"/>
	      	      ...
	      	      <s:password cssClass="form-control" name="oldPassword" placeholder="******"/>
              </div>
              <div class="form-group">
	              <s:fielderror fieldName="newPassword" cssClass="alert alert-danger text-center"/>
	      	      ...
	      	      <s:password cssClass="form-control" name="newPassword" placeholder="******"/>
              </div>
			  <s:hidden name="%{#attr._csrf.parameterName}" value="%{#attr._csrf.token}"/>
              <div class="form-group">
	      	      <s:submit key="global.change_password"/>
              </div>
	      	</s:form>
            </div>
	      </div>
